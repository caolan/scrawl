...
exports.countNewLines = function (str) {
    var count = 0;
...
exports.parse = function (str) {
    ...
    while (match = (/\/\*\*([\s\S]*?)\*\//g).exec(str)) {
        ...
        lineno += exports.countNewLines(_str.substr(0, match.index));
        str = str.substr(match.index + match[1].length);
        var comment = exports.parseComment(match[1]);
        comment.line = lineno;
        comments.push(comment);
        // add lines from the comment itself
        lineno += exports.countNewLines(
            _str.substr(match.index, match[1].length)
        );
    };
    return comments;
};
